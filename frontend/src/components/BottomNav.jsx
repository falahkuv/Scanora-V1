...
const BottomNav = ({ onOpenScanner }) => {
  ...
  return (
    <div className="absolute bottom-0 left-0 w-full bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 px-4 py-3 flex justify-evenly items-center pb-safe rounded-t-3xl shadow-[0_-4px_20px_rgba(0,0,0,0.05)] z-50 transition-colors mt-auto">
      <button 
        onClick={() => navigate('/')}

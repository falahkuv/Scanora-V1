...
import uvicorn
import os
from estimation_service import get_all_estimations
...
async def predict(file: UploadFile = File(...)):
    ...
    try:
        ...
        # Dapatkan estimasi tanggal untuk kedua skenario penyimpanan
        estimations = get_all_estimations(product, condition)

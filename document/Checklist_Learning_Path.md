# 📋 Project Plan & Checklist Learning Path - Scanora V1
...
- [x] RESTful API dapat menyimpan data dengan atau tanpa menggunakan database.
...
**Task Wajib:**
- [x] Membangun model Deep Learning menggunakan TensorFlow Functional API atau Model Subclassing, yang disesuaikan dengan dataset dan permasalahan bisnis yang telah ditentukan oleh tim Data Science (jika ada).
- [x] Mengimplementasikan setidaknya satu komponen kustom lanjutan dalam proses pengembangan model, seperti:
  - Custom Layer
  - Custom Loss Function
  - Custom Callback
- [x] Menyimpan dan mengekspor model yang telah dilatih secara penuh dalam format TensorFlow siap produksi (.keras atau SavedModel).
- [x] Membuat kode sederhana untuk proses inference model.

**Opsional (Nilai Tambah):**
- [x] Mengembangkan REST API mandiri menggunakan FastAPI atau Flask untuk melayani model machine learning.
...
- [x] Melakukan proses Data Wrangling secara end-to-end, yang mencakup:
